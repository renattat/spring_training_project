...
@SpringBootApplication(scanBasePackages= {"ru.renat.pma", "ru.renat.utils"})
public class PmProjectManagementApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(PmProjectManagementApplication.class, args);
	}
